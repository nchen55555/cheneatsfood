...
app.config.update(dict(
    ...
    MAIL_USE_TLS = True,
    MAIL_USE_SSL = False,
    MAIL_USERNAME = 'nicole_chen@college.harvard.edu',
    MAIL_PASSWORD = 'Myshiyi2hvrd',
))
mail = Mail(app)
...
def info():
    ...
    #request is through POST
        ...
        if status == "valid":
            ...
            msg = Message('DTC Computer Science Camp Registration', sender = 'nicole_chen@college.harvard.edu', recipients = [email])
...
def contact():
    ...
    #since request was through POST 
        ...
        if status == "valid":
            ...
            msg = Message('Contact Us Message', sender = 'nicole_chen@college.harvard.edu', recipients = ['nicole_chen@college.harvard.edu'])
...
def volunteers():
    ...
    #request was taken via POST 
        ...
        if status == "valid":
            ...
            msg = Message('DTC Computer Science Camp Volunteer Application', sender = 'nicole_chen@college.harvard.edu', recipients = [email])
